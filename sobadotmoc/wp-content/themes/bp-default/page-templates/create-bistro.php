<?php/* Template Name: Create bistro page */?>
<?php get_header(); ?>
		...
		<?php do_action( 'template_notices' ); ?>
			...
			<nav id="navigation-sub" role="navigation">
						<ul id="menu-main_nav_sub">
							...
							<li class="menu-quick-easy_page active"><a href="<?php echo home_url(); ?>/create-bistro/" style="width:220px"><img src="<?php bloginfo('stylesheet_directory'); ?>/_inc/images/new-icon.png" style="position: absolute;margin-left: -30px;margin-top: 6px;">สร้างร้านอาหาร</a></li>
